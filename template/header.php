...
<head>
  ...
  <link rel="icon" href="kasir-logo.png">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary  text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
...
<div class="bg-primary text-center py-2 shadow-sm sticky-top d-none d-md-block">
    ...
    <div class="col-md-3 mb-2 d-none d-md-block">
        <div class="card">
            <div class="card-header bg-primary">
                <div class="card-tittle text-white">Halo, <b><?php echo $userr ?></b></div>
            </div>
            <div class="card-body">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php"><i class="fa fa-desktop text-primary mr-2"></i>Kasir</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="barang.php"><i class="fa fa-shopping-bag text-primary mr-2"></i>Barang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="laporan.php"><i class="fa fa-table text-primary mr-2"></i>Laporan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pengaturan.php"><i class="fa fa-cog text-primary mr-2"></i>Pengaturan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="logout.php"onclick="javascript:return confirm('Anda yakin ingin keluar ?');"><i class="fa fa-power-off text-primary mr-2"></i>Keluar</a>
                    </li>
                </ul>
         </div>
    </div>
