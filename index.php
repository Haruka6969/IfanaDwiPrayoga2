    ...
    <div class="col-md-6 mb-3">
        <div class="card">
            ...
            <div class="form-group row mb-0">
                        <label class="col-sm-4 col-form-label col-form-label-sm"><b>Tanggal Transaksi</b></label>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary btn-sm" name="save" value="simpan" type="submit">
...
<div class="col-md-6 mb-3">
    ...
    <div class="text-right mt-3">
        <form method="POST">
            <button class="btn btn-primary-light btn-sm mr-2" onclick="printContent('print')"><i class="fa fa-print mr-1"></i> Print</button>
            <button class="btn btn-primary btn-sm" name="selesai" type="submit"><i class="fa fa-check mr-1"></i> Selesai</button>
        </form>
    </div>
    <?php
